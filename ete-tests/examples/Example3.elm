    ...
    div
        [ css [ Tw.bg_white ]]
          [ div
            [ css [ Tw.max_w_7xl, Tw.mx_auto, Tw.py_24, Tw.px_4, Bp.lg [ Tw.px_8 ], Bp.sm [ Tw.px_6 ] ]]
              [ div
                [ css [ Bp.sm [ Tw.flex, Tw.flex_col, Tw.hidden ] ]]
                  [ h1
                    [ css [ Tw.text_5xl, Tw.font_extrabold, Tw.text_gray_900, Bp.sm [ Tw.text_center ] ]]
                      [ text "Pricing Plans" ]
                , p
            ...
            , div
                [ css [ Tw.mt_12, Tw.space_y_4, Bp.lg [ Tw.max_w_4xl, Tw.mx_auto ], Bp.sm [ Tw.mt_16, Tw.space_y_0, Tw.grid, Tw.grid_cols_2, Tw.gap_6 ], Bp.xl [ Tw.max_w_none, Tw.mx_0, Tw.grid_cols_4 ] ]]
                  [ div
                    [ css [ Tw.border, Tw.border_gray_200, Tw.rounded_lg, Tw.shadow_sm, Tw.divide_y, Tw.divide_gray_200 ]]
                      [ div
                        [ css [ Tw.p_6 ]]
                          [ h2
                    ...
                    , div
                        [ css [ Tw.pt_6, Tw.pb_8, Tw.px_6 ]]
                          [ h3
                            [ css [ Tw.text_xs, Tw.font_medium, Tw.text_gray_900, Tw.tracking_wide, Tw.uppercase ]]
